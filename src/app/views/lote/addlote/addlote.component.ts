...
//Propiedades relacionadas al form
  ...
  get unidadProductivaFieldInvalid(){
    return this.unidadProductiva?.touched && this.unidadProductiva.invalid;
  }

  get unidadProductiva(){
    return this.formulario.get('unidadProductiva');
  }
  ...
  crearLote(): void{
    ...
    let unidadProductiva: UnidadProductiva = new UnidadProductiva();
    unidadProductiva.id = this.unidadProductiva?.value;
